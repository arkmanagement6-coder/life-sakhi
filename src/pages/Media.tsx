...
const Media: React.FC = () => {
  ...
  const news = [
    { title: "Life Changing Trust launches Life Sakhi brand for Rural Women Health", source: "Dainik Bhaskar", date: "April 10, 2026" },
    { title: "NGO sets up computer labs in 10 block schools in Haryana", source: "The Tribune", date: "March 18, 2026" },
    { title: "80G and CSR certification awarded to Life Changing Trust", source: "MCA Gazette", date: "January 05, 2026" }
  ];
