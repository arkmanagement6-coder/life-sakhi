...
export interface UserDoc extends BaseDocument {
  ...
  displayName: string;
  phone: string;
  role: 'admin' | 'volunteer' | 'donor' | 'women_distributor' | 'district_coordinator' | 'block_coordinator' | 'state_coordinator' | 'csr_partner' | 'corporate_partner' | 'hiring_partner' | 'hospital' | 'school' | 'ngo_partner' | 'doctor' | 'delivery_staff' | 'user';
